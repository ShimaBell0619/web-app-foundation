...
- fe0febf: BREAKING: retire the GitHub Pages deployment and PR-preview capability and make Vercel Git Integration the default hosting profile for new consumers. Use owner-managed stable domains for Production and Fixed Staging while keeping ordinary PR previews on Vercel-provided Preview URLs by default.
